...
const Header = () => {
  ...
  const navItems = [
    ...
    { label: 'Limpeza', href: '/catalog/limpeza' },
    { label: 'Higiene', href: '/catalog/higiene' },
    { label: 'EPI', href: '/catalog/epi' },
    { label: 'Descartáveis', href: '/catalog/descartaveis' },
    { label: 'Plásticos', href: '/catalog/plasticos' },
    { label: 'Papelaria', href: '/catalog/papelaria' },
    { label: 'Escritório', href: '/catalog/escritorio' },
    { label: 'Informática', href: '/catalog/it' },
